...
const getEditorStyles = (theme: "light" | "dark", options?: { viewer?: boolean }) => {
  ...
  * { box-sizing: border-box; }
  ...
  .edgeever-editor-content code { border-radius: 4px; padding: 2px 5px; border: 1px solid ${theme === "dark" ? "rgba(255,255,255,0.1)" : "#e2e8f0"}; background: ${theme === "dark" ? "#1e293b" : "#f1f5f9"}; color: ${theme === "dark" ? "#e2e8f0" : "#0f172a"}; font-family: ui-monospace, SFMono-Regular, Menlo, monospace; font-size: 0.88em; }
  .edgeever-editor-content pre code { padding: 0; border: 0; background: transparent; font-size: inherit; }
