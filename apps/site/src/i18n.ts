...
export const siteCopy = {
  "zh-CN": {
    ...
    hero: {
      ...
      terminalCmd: "帮我在 Cloudflare 或 Docker 部署 EdgeEver：Fork https://github.com/tianma-if/edgeever 并绑定 D1/R2",
      terminalSub: "Agent 原生 · 复制 Prompt 粘贴给 Cursor / Claude Code / Antigravity 即可自动部署，或在 VPS 执行 Docker 一键安装",
  ...
  "en-US": {
    ...
    hero: {
      ...
      terminalCmd: "Deploy EdgeEver on Cloudflare or Docker: Fork https://github.com/tianma-if/edgeever & bind D1/R2",
      terminalSub: "Agent Native · Copy prompt to Cursor / Claude Code / Antigravity, or run 1-line Docker script on VPS",
