...
export const DEMO_ARCHITECTURE_DIAGRAM_ZH: DiagramDocument = {
  ...
  kind: "architecture",
  nodes: [
    { id: "boundary-clients", label: "全端体验层", x: 40, y: 40, width: 1120, height: 220, shape: "boundary" },
    { id: "boundary-platform", label: "可移植应用平台 · Cloudflare Workers / Docker 共用业务核心", x: 40, y: 300, width: 1120, height: 220, shape: "boundary" },
    { id: "boundary-data", label: "数据与文件层 · 可替换基础设施适配器", x: 40, y: 560, width: 690, height: 210, shape: "boundary" },
    { id: "boundary-ecosystem", label: "AI 与自动化生态", x: 770, y: 560, width: 390, height: 210, shape: "boundary" },

    { id: "client-web", label: "Web / PWA\n离线优先", x: 68, y: 86, width: 180, height: 64, shape: "frontend", resourceIcon: "webApp", parentId: "boundary-clients" },
    { id: "client-desktop", label: "macOS / Windows\n桌面端", x: 284, y: 86, width: 180, height: 64, shape: "client", resourceIcon: "client", parentId: "boundary-clients" },
    { id: "client-ios", label: "iOS\nSwiftUI 原生端", x: 500, y: 86, width: 180, height: 64, shape: "client", resourceIcon: "mobileApp", parentId: "boundary-clients" },
    { id: "client-android", label: "Android\nExpo 原生端", x: 716, y: 86, width: 180, height: 64, shape: "client", resourceIcon: "mobileApp", parentId: "boundary-clients" },
    { id: "client-clipper", label: "浏览器剪藏\nChrome / Edge", x: 932, y: 86, width: 180, height: 64, shape: "client", resourceIcon: "website", parentId: "boundary-clients" },
    { id: "client-sync", label: "全端共享同步通道", x: 490, y: 184, width: 200, height: 48, shape: "service", resourceIcon: "apiClient", parentId: "boundary-clients" },

    { id: "platform-api", label: "统一 API 入口\n认证 · 限流 · 路由", x: 490, y: 338, width: 200, height: 64, shape: "service", resourceIcon: "apiGateway", parentId: "boundary-platform" },
    { id: "platform-core", label: "共享业务核心\nHono · 领域服务", x: 490, y: 430, width: 200, height: 64, shape: "service", resourceIcon: "service", parentId: "boundary-platform" },
    { id: "platform-sync", label: "同步与修订引擎\n离线队列 · 冲突控制", x: 220, y: 430, width: 200, height: 64, shape: "service", resourceIcon: "streamProcessing", parentId: "boundary-platform" },
    { id: "platform-mcp", label: "原生 MCP 端点\n智能体读写工具", x: 760, y: 430, width: 190, height: 64, shape: "service", resourceIcon: "mcpServer", parentId: "boundary-platform" },
    { id: "platform-model", label: "端侧模型网关\nBYOK 隐私直连", x: 980, y: 430, width: 170, height: 64, shape: "service", resourceIcon: "modelGateway", parentId: "boundary-platform" },

    { id: "data-search", label: "搜索与语义索引\n全文 · 向量", x: 76, y: 632, width: 186, height: 76, shape: "database", resourceIcon: "vectorDatabase", parentId: "boundary-data" },
    { id: "data-sql", label: "D1 / SQLite\n笔记 · 标签 · 修订", x: 292, y: 632, width: 186, height: 76, shape: "database", resourceIcon: "relationalDatabase", parentId: "boundary-data" },
    { id: "data-objects", label: "R2 / S3\n图片与附件", x: 508, y: 632, width: 186, height: 76, shape: "storage", resourceIcon: "objectStorage", parentId: "boundary-data" },

    { id: "ecosystem-agents", label: "Claude / Cursor\n自动化智能体", x: 796, y: 632, width: 170, height: 76, shape: "external", resourceIcon: "aiAgent", parentId: "boundary-ecosystem" },
    { id: "ecosystem-models", label: "OpenAI / Gemini\n兼容模型服务", x: 974, y: 632, width: 170, height: 76, shape: "external", resourceIcon: "largeLanguageModel", parentId: "boundary-ecosystem" },
  ],
  edges: [
...
export const DEMO_ARCHITECTURE_DIAGRAM_EN: DiagramDocument = {
  ...
  kind: "architecture",
  nodes: [
    { id: "boundary-clients", label: "Cross-Platform Experience", x: 40, y: 40, width: 1120, height: 220, shape: "boundary" },
    { id: "boundary-platform", label: "Portable Application Platform · Shared Core on Cloudflare Workers or Docker", x: 40, y: 300, width: 1120, height: 220, shape: "boundary" },
    { id: "boundary-data", label: "Data & Files · Replaceable Infrastructure Adapters", x: 40, y: 560, width: 690, height: 210, shape: "boundary" },
    { id: "boundary-ecosystem", label: "AI & Automation Ecosystem", x: 770, y: 560, width: 390, height: 210, shape: "boundary" },

    { id: "client-web", label: "Web / PWA\nOffline First", x: 68, y: 86, width: 180, height: 64, shape: "frontend", resourceIcon: "webApp", parentId: "boundary-clients" },
    { id: "client-desktop", label: "macOS / Windows\nDesktop", x: 284, y: 86, width: 180, height: 64, shape: "client", resourceIcon: "client", parentId: "boundary-clients" },
    { id: "client-ios", label: "iOS\nNative SwiftUI", x: 500, y: 86, width: 180, height: 64, shape: "client", resourceIcon: "mobileApp", parentId: "boundary-clients" },
    { id: "client-android", label: "Android\nNative Expo", x: 716, y: 86, width: 180, height: 64, shape: "client", resourceIcon: "mobileApp", parentId: "boundary-clients" },
    { id: "client-clipper", label: "Web Clipper\nChrome / Edge", x: 932, y: 86, width: 180, height: 64, shape: "client", resourceIcon: "website", parentId: "boundary-clients" },
    { id: "client-sync", label: "Shared Cross-Client Sync", x: 490, y: 184, width: 200, height: 48, shape: "service", resourceIcon: "apiClient", parentId: "boundary-clients" },

    { id: "platform-api", label: "Unified API Entry\nAuth · Limits · Routing", x: 490, y: 338, width: 200, height: 64, shape: "service", resourceIcon: "apiGateway", parentId: "boundary-platform" },
    { id: "platform-core", label: "Shared Business Core\nHono · Domain Services", x: 490, y: 430, width: 200, height: 64, shape: "service", resourceIcon: "service", parentId: "boundary-platform" },
    { id: "platform-sync", label: "Sync & Revision Engine\nOffline Queue · Conflicts", x: 220, y: 430, width: 200, height: 64, shape: "service", resourceIcon: "streamProcessing", parentId: "boundary-platform" },
    { id: "platform-mcp", label: "Native MCP Endpoint\nAgent Read/Write Tools", x: 760, y: 430, width: 190, height: 64, shape: "service", resourceIcon: "mcpServer", parentId: "boundary-platform" },
    { id: "platform-model", label: "Client Model Gateway\nPrivate BYOK", x: 980, y: 430, width: 170, height: 64, shape: "service", resourceIcon: "modelGateway", parentId: "boundary-platform" },

    { id: "data-search", label: "Search & Semantic Index\nFull Text · Vectors", x: 76, y: 632, width: 186, height: 76, shape: "database", resourceIcon: "vectorDatabase", parentId: "boundary-data" },
    { id: "data-sql", label: "D1 / SQLite\nNotes · Tags · Revisions", x: 292, y: 632, width: 186, height: 76, shape: "database", resourceIcon: "relationalDatabase", parentId: "boundary-data" },
    { id: "data-objects", label: "R2 / S3\nImages & Attachments", x: 508, y: 632, width: 186, height: 76, shape: "storage", resourceIcon: "objectStorage", parentId: "boundary-data" },

    { id: "ecosystem-agents", label: "Claude / Cursor\nAutomation Agents", x: 796, y: 632, width: 170, height: 76, shape: "external", resourceIcon: "aiAgent", parentId: "boundary-ecosystem" },
    { id: "ecosystem-models", label: "OpenAI / Gemini\nCompatible Models", x: 974, y: 632, width: 170, height: 76, shape: "external", resourceIcon: "largeLanguageModel", parentId: "boundary-ecosystem" },
  ],
  edges: [
