...
export const NotebookTreeItem = ({
  ...
  return (
    <div>
        ...
        <ContextMenuTrigger asChild>
          ...
          >
            ...
            <div ref={actionsRef} className="relative shrink-0">
              ...
              {actionsOpen && (
                <div className="edgeever-popover-enter absolute right-0 top-8 z-50 w-44 overflow-hidden rounded-md border border-slate-200 bg-white p-1 text-slate-950 shadow-lg">
                  <button
      ...
      {hasChildren && open ? (
        <div className="edgeever-tree-enter mt-1 space-y-1">
