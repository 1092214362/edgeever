...
const applyInlineStyles = (root: HTMLElement, editorTheme?: string) => {
  ...
  root.querySelectorAll<HTMLElement>("[data-edgeever-theme-block]").forEach((block) => {
    ...
    const accent = editorTheme === "red-white" ? "#dc2626" : editorTheme === "olive-journal" ? "#ed7b2f" : editorTheme === "graphite-minimal" ? "#52525b" : editorTheme === "mint-breeze" ? "#00a86b" : editorTheme === "minimal-emerald" ? "#059669" : editorTheme === "outline-emerald" ? "#059669" : "#059669";
