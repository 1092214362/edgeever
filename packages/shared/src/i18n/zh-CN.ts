...
export const zhCN = {
  ...
  systemInfo: {
    ...
    updateAvailableDescription: "<paragraph>新版本 v{{version}} 已发布。Cloudflare 和 Docker 实例<strong>默认每日自动更新，无需手动操作</strong>。</paragraph><paragraph><strong>请勿使用 Sync fork 更新 EdgeEver</strong>；若误点后提示冲突，直接关闭窗口即可。</paragraph><paragraph>如需立即更新：Cloudflare 用户可运行 Update deployed EdgeEver 工作流；Docker 用户可运行 ~/edgeever/update.sh。</paragraph><paragraph>桌面客户端需前往 Releases 页面下载更新。</paragraph>",
    viewRelease: "查看更新",
