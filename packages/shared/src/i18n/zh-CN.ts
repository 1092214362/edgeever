...
export const zhCN = {
  ...
  aiPrompts: {
    title: "提示词中心",
    description: "管理可复用的笔记处理提示词。新工作区会预置常用示例，你可随意编辑或删除。",
    nav: "提示词",
    openLibrary: "打开提示词中心",
    settingsTitle: "AI 提示词",
    settingsDescription: "可复用的提示词会在 AI 助手处理方式中出现；可在提示词中心统一管理。",
    listTitle: "全部提示词",
    listSubtitle: "包含预置示例与你自己创建的提示词，均可编辑",
    empty: "还没有提示词。可在此新建，或恢复默认提示词。",
    emptyHint: "点击「新建提示词」，或「恢复默认提示词」找回预置示例。",
    count: "{{count}} 条",
    add: "新建提示词",
    edit: "编辑提示词",
    create: "创建",
    save: "保存",
    delete: "删除",
    deleteConfirm: "确定删除提示词“{{name}}”吗？预置提示词可稍后通过「恢复默认提示词」找回。",
    preview: "查看内容",
    restoreDefaults: "恢复默认提示词",
    restoreDefaultsHint: "仅补回已删除的预置项，不会覆盖你改过的内容，也不会删除你新建的提示词。",
    restoreDefaultsConfirmTitle: "恢复默认提示词？",
    restoreDefaultsConfirmDescription: "将补回缺失的预置提示词（如总结、提炼要点等）。你已编辑过的预置项与自行新建的提示词不会被改动。",
    restoreDefaultsConfirm: "恢复",
    restoreDefaultsDone: "已恢复 {{count}} 条默认提示词。",
    restoreDefaultsNone: "默认提示词都在，无需恢复。",
    name: "名称",
    namePlaceholder: "例如：周报提炼 / 会议待办",
    descriptionLabel: "描述（可选）",
    descriptionPlaceholder: "简要说明何时使用这条提示词",
    instruction: "提示词内容",
  ...
  aiAssistant: {
    ...
    transparentHint: "下方即实际发送给 AI 的提示词，与提示词中心同一套，可直接改。",
    managePrompts: "提示词中心",
    actions: {
      summarize: "总结",
    ...
    saveAsPrompt: "保存为提示词",
    saveAsPromptTitle: "保存为提示词",
    updatePrompt: "更新此提示词",
    promptName: "名称",
    promptNamePlaceholder: "例如：周报提炼",
    promptDescription: "描述（可选）",
    promptSaved: "提示词已保存。",
    promptMissing: "所选提示词已不存在，请重新选择。",
