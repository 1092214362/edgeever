...
export const zhCN = {
  companion: {
    ...
    discovery: {
      ...
      openCompanionDesc: "查看猫爪记住的偏好、操作依据和对话。",
      panelDescription: "不需要逐条处理。只有你确认的操作才会改变笔记；发现 7 天后自动隐藏。",
      unread: "有新发现",
      empty: "暂时没有值得打扰你的发现。继续记录就好。",
      loadFailed: "暂时无法读取发现，请稍后重新打开。",
      actionFailed: "操作或同步未完成。请查看执行记录与最新笔记，不要重复提交。",
      appendHelp: "将随手记的正文原样追加到目标笔记末尾，保留两篇原笔记；不自动删除或改写。本期仅对纯文字笔记生成此建议。",
      dismiss: "略过这条",
      kind: { move: "建议 · 归档", tag: "建议 · 添加标签", insight: "知识关联 · 无需操作", merge: "整理建议 · 合并点子", append: "整理建议 · 补入已有笔记" },
      ...
      transparency: {
        title: "猫爪状态",
        state: { disabled: "未运行", quiet: "安静观察中", ready: "最近检查完成", running: "正在检查", failed: "检查未完成" },
        lastCheck: "最近检查",
        neverChecked: "尚未检查",
        nextCheck: "下次检查",
        nextCheckEnabled: "停止操作 3 分钟后：笔记变化每天检查；记忆变化可提前触发，每小时最多一次",
        nextCheckDisabled: "启用后才会检查",
        scope: "每次只选取当前账户中少量相关笔记交给默认模型。没有有价值的结果时保持安静；任何笔记改动都需要你确认。",
        latest: "最近发现",
        noDiscovery: "还没有生成值得提醒你的发现。猫爪会继续安静等待新的笔记变化。",
      },
    },
    "actions": {
      "confirm": "确认",
      ...
      "tools": {
        ...
        "restore_memos": "恢复笔记",
        "move_memos": "移动笔记",
        "add_tags_to_memos": "追加标签",
        "remove_tags_from_memos": "移除标签",
        "rename_tag": "重命名标签",
        "delete_tag": "删除标签",
        "merge_memos": "合并笔记",
        "restore_memo_revision": "恢复历史版本",
        "move_notebook": "移动笔记本",
      ...
      "effects": {
        "merge_memos": "合并保留原文、附件和标签。原笔记进入回收站，原公开分享失效；恢复原笔记不等于完整撤销合并。",
        "trash_memos": "这些笔记将进入回收站，原公开分享失效。这不是永久删除。",
        "rename_tag": "会修改当前账户内所有使用这个标签的笔记。",
        "delete_tag": "会从当前账户内所有相关笔记中移除这个标签，不删除笔记正文。",
        "update_memo": "列出的字段将替换原值；完整正文和标签列表不是追加操作。请核对后确认。",
        "restore_memo_revision": "当前内容将被指定历史版本替换，请先核对笔记和版本。"
      },
      "merge": "建议合并这些点子",
      "tag": "建议补充标签",
      "resultTitle": "合并后的标题：{{title}}",
      "existingTags": "已有标签：{{tags}}",
      "addTags": "仅追加：{{tags}}",
      "dismiss": "忽略建议",
      "openResult": "打开处理后的笔记",
      "conflict": "笔记、记忆或建议状态已变化，或建议已过期。没有执行新的修改，请重新生成整理方案。",
      "unsynced": "请先联网并完成笔记同步、处理同步冲突，再确认整理方案。",
      "syncFailed": "整理已完成，但本机尚未刷新成功。请手动同步查看结果，不需要再次整理。",
      "status": { "applied": "已执行", "dismissed": "已忽略", "unavailable": "暂不可执行或已失效，请重新生成方案", "uncertain": "执行已开始，结果尚未确认，可能已有部分修改。请刷新并检查笔记；不会重复执行。" }
    },
    "title": "与 EdgeEver 聊聊",
    "navTitle": "EdgeEver",
    ...
    "backToNotes": "返回笔记",
    "settings": "设置",
    "emptyTitle": "从你的笔记，到你的想法",
    "privacyTitle": "发送内容会交给默认模型服务商 · 数据与权限说明",
    "unavailableHelp": "这里是你的独立聊天与记忆空间。当前实例为演示模式、未开启登录或尚未登录，因此暂不读取或保存个人记忆。请使用开启登录的非演示实例，并登录个人账户；聊天前还需在个人中心的 AI 集成中配置默认模型。",
    "intro": "不只是改写笔记：让 EdgeEver 记住你明确告诉她的偏好。",
    "privacy": "使用已配置的默认 AI 模型。发送时，对话、启用的记忆及检索到的笔记片段会交给该模型服务商；记忆与聊天保存在当前实例服务端，不是设备本地专有数据。",
    "chat": "聊天",
    "memories": "她记得的事",
    "history": "最近会话",
    "newChat": "新对话",
    "waiting": "尚无回复内容",
    "rememberMessage": "记住我这句话",
    "stop": "停止",
    "memoryHelp": "猫爪会区分你明确告知的偏好和根据操作形成的推测。候选或冲突记忆不会用于建议；纠正后以你的说法为准。最多 50 条，每条 500 字。",
    "correct": "纠正",
    "addMemory": "让她记住一件事",
    "forget": "忘记",
    "fromMessage": "来源：你主动保存的对话原话",
    "fromManual": "来源：你手动添加或修改",
    "backupHelp": "预览数据尚未纳入笔记 ZIP 备份，也不支持原生移动端或桌面离线同步。请单独导出记忆、聊天与整理记录；导入合并记忆与学习设置，不恢复聊天或整理记录；导入的推测需要重新确认。导出文件包含明文，请妥善保管。",
    "export": "导出记忆与聊天",
    "import": "导入记忆",
    "clearHistory": "清空聊天记录",
    "useMemory": "使用已保存记忆",
    "allowNotes": "允许使用笔记工具（修改须确认）",
    "contextHelp": "未勾选笔记权限时不会调用笔记工具。开启后可读取笔记、标签、笔记本及历史信息；创建、修改、合并、移动、标签管理、回收站和版本恢复均先展示具体参数，由你确认执行。关闭记忆后，仍可接续本会话中未使用记忆的对话。只在发送时调用模型。",
    "message": "想和 EdgeEver 聊些什么？",
    "send": "发送",
    "clearHelp": "删除全部聊天、发现及操作记录（不可撤销），并停止当前生成；保留记忆和发现设置。已略过的来源组可能再次出现。可先导出备份。",
    "forgetHelp": "删除这条记忆及关联学习证据，不再自动学习同一条规律，停止当前生成，并从后续自动上下文中排除旧回复。已有聊天文本、导出备份及模型服务商的数据不会随之删除；需要时请另行清空。",
    "configureModel": "请先在 AI 设置中配置默认模型，再开始聊天。",
    "credentialsRejected": "默认模型的密钥被拒绝。请在 AI 设置中检查服务商地址和密钥。",
    "providerPaymentRequired": "模型服务商返回额度不足，请检查账户余额后重试。",
    "providerRateLimited": "模型服务商限流，请稍后再试。",
    "providerRequestRejected": "默认模型拒绝了这次请求。请确认该模型支持工具调用，或更换默认模型。",
    "conflict": "记忆已被其他操作修改，或超过 50 条上限。请刷新后再试。",
    "historyFull": "聊天与发现已达到合计 500 条历史上限，请先导出并清空历史。",
    "unavailable": "预览功能仅对非演示实例中已登录的个人账户开放。",
    "failed": "操作未完成。请检查网络和默认模型配置，并刷新查看已保存结果；不会自动重复调用模型。",
    "recovered": "生成已停止或连接中断，正在恢复已保存内容。可刷新查看最终状态，不会自动重新生成。",
    "status": {
      "running": "生成中（刷新可恢复）",
      "completed": "已完成",
  ...
  structuredTable: {
    ...
    recordCountFiltered: "{{count}} / {{total}} 条记录",
    listCounts: "{{records}} 条记录 · {{fields}} 个字段",
    newField: "字段 {{index}}",
    fieldLimit: "最多 40 个字段",
    recordLimit: "最多 2000 条记录",
    unreadable: "这份多维表格无法读取",
    saveError: "表格保存失败",
    editSessionError: "暂时无法建立安全编辑会话，请稍后重试。",
    saving: "保存中",
    saved: "已保存",
    unsaved: "有未保存的修改",
    back: "返回笔记列表",
    ...
    form: {
      ...
      copied: "已复制",
      password: "访问密码",
      passwordHint: "打开后自动生成密码。对方需要密码才能打开填写页。",
      regenerate: "重新生成密码",
      formTitle: "表单标题",
      formDescription: "说明",
      submitLabel: "按钮上的文字",
  ...
  diagram: {
    ...
    architectureShortcuts: "拖动端点连接组件，Enter 编辑，⌘/Ctrl+D 复制",
    addDecision: "添加判断节点",
    addTerminator: "添加起止节点",
    addClient: "添加客户端",
    addFrontend: "添加前端",
    addService: "添加服务",
    addDatabase: "添加数据库",
    ...
    componentCategoryAi: "AI 与机器学习",
    componentCategoryDatabases: "数据库",
    componentCategoryStorage: "存储与 CDN",
    componentCategoryMiddleware: "互联网中间件",
    componentCategoryNetwork: "网络",
    componentCategorySecurity: "安全与边界",
    componentCategoryObservability: "管理与监控",
    componentCategoryExternal: "外部服务",
    noMatchingComponents: "没有匹配的架构组件",
    architectureResources: {
      ...
      modelGateway: "模型网关",
      mcpServer: "MCP 服务器",
      relationalDatabase: "关系型数据库",
      noSqlDatabase: "NoSQL 数据库",
      cache: "缓存",
      dataWarehouse: "数据仓库",
      searchEngine: "搜索引擎",
      objectStorage: "对象存储",
    ...
    newExternal: "外部系统",
    newBoundary: "系统边界",
    quickCreateTitle: "选择后续节点类型",
    quickCreateShortcuts: "按 1 / 2 / 3 选择，Esc 取消",
    nodeText: "节点文字",
    nodeIcon: "节点图标",
    changeNodeIcon: "更换节点图标",
    edgeText: "连线说明",
    editNode: "编辑节点文字",
    ...
    readFlow: "从起点阅读",
    readFlowHint: "以原始字号从起点阅读；滚轮或拖动画布浏览，Ctrl / ⌘ + 滚轮缩放",
    fit: "适应画布",
    autoLayout: "自动布局",
    ...
    themeNaive: "糖纸",
    structure: "形状",
    structureGroupMap: "思维导图",
    structureGroupLogic: "逻辑图",
    structureGroupBrace: "括号图",
    structureGroupOrg: "组织结构图",
    structureGroupTree: "树形图",
    structureGroupTimeline: "时间轴",
    structureGroupFishbone: "鱼骨图",
    structureLogic: "逻辑图",
    structureMap: "脑图",
    structureLine: "线条",
    structureCapsule: "胶囊",
    ...
    structureBrace: "括号",
    structureOrg: "组织图",
    structureTimeline: "时间轴",
    structureFishbone: "鱼骨图",
    export: "导出",
    exportPng: "导出 PNG",
    exportSvg: "导出 SVG",
    exportError: "图表导出失败",
    ...
    discardDescription: "返回笔记列表后，本次尚未保存的图表修改会丢失。",
    discard: "放弃修改",
  },
  workspace: {
    ...
    selection: {
      ...
      merge: "合并笔记",
      export: "导出 Markdown",
      exportHint: "将选中笔记的已保存版本打包为 Markdown 压缩包（含附件）",
      exporting: "正在导出",
      exportProgress: "正在导出 {{completed}} / {{total}}",
      trashCannotExport: "回收站内不可导出",
      exportTooMany: "一次最多导出 {{max}} 条笔记",
      exportLocalOnly: "未同步的笔记无法导出，请先同步后再试",
      exportEmpty: "没有可导出的笔记",
      exportError: "导出失败，请检查网络连接后重试",
      exportCompleteWithSkipped: "已开始下载 Markdown 压缩包。已跳过 {{count}} 条未同步笔记。",
      deleting: "正在删除",
  ...
  notebookPane: {
    ...
    profile: "个人中心",
    collapseSidebar: "收起笔记本栏",
    expandSidebar: "展开笔记本栏",
    trash: "回收站",
    emptyTrash: "清空回收站",
    empty: "清空",
    syncNow: "立即同步",
  ...
  settings: {
    ...
    editorBodyFontDescription: "只改变本机的笔记正文。",
    editorBodyFonts: {
      system: "跟随系统",
      wenkai: "霞鹜文楷",
      wenkaiScreen: "霞鹜文楷屏幕版",
      zhuque: "朱雀仿宋",
      sourceHanSerif: "思源宋体",
      neoZhiSong: "霞鹜新致宋",
      sourceHanSans: "思源黑体",
    ...
    editorThemes: {
      ...
      zen: "雾色静页",
      grove: "林间手记",
      "minimal-emerald": "极简青翠",
      "outline-emerald": "线描翠绿",
      "wechat-green": "微信新绿",
      "modern-mint": "薄荷清新",
      custom: "自定主题",
    },
    customEditorTheme: {
      ...
      settingsTitle: "自定义主题",
      settingsDescription: "全部排版主题在编辑器工具栏切换。这里只管理保存在当前浏览器中的自定义配色。",
      defaultName: "自定主题",
      newName: "新主题 {{n}}",
      create: "新建主题…",
      edit: "编辑配色",
  ...
  plugins: {
    ...
    schedules: {
      legacyTitle: "旧版手动任务",
      legacyDescription: "这些任务由旧版本手动创建。新的定时任务请在对应插件的设置中配置；你仍可在这里停用或删除旧任务。",
      toggle: "启用或停用 {{name}}",
      delete: "删除 {{name}}",
      history: "执行记录",
      historyFor: "查看 {{name}} 的执行记录",
      historyTitle: "{{name}} · 执行记录",
  ...
  executionHistory: {
    centerTitle: "定时任务日志",
    centerDescription: "查看系统后台任务的执行状态、耗时和错误详情。",
    openCenter: "定时任务日志",
    pluginSchedule: "插件 {{plugin}} · {{key}}",
    pagination: "执行记录分页",
  ...
  objectStorage: {
    ...
    saved: "对象存储设置已保存。",
    failed: "对象存储操作失败。",
    authenticationRequired: "保存第三方存储凭据前，请在部署环境中设置 EDGE_EVER_AUTH_PASSWORD。Docker 会把该密钥写入数据卷，避免以后升级时丢失。",
  ...
  aiModel: {
    ...
    saved: "模型服务已保存。",
    failed: "AI 模型操作失败。",
    encryptionKeyMissing: "当前实例无法加密保存 AI 凭据。请在部署环境中设置 EDGE_EVER_AUTH_PASSWORD，或可选的 EDGE_EVER_CREDENTIALS_ENCRYPTION_KEY，然后重启实例。Docker 会把密钥写入数据卷，避免以后升级时丢失。",
  ...
  aiPrompts: {
    ...
    restoreDefaultsConfirmDescription: "将补回缺失的预置指令（如精简总结、全文翻译等）。你已编辑过的预置项与自行新建的指令不会被改动。",
  ...
  aiAssistant: {
    ...
    customInstructionSelected: "告诉 AI 你想怎么处理这段",
    customInstructionSelectedPlaceholder: "例如：改得更口语、保留术语、不要改结构。",
    customInstructionRequired: "请输入你希望 AI 执行的指令。",
    inputContent: "输入要处理的内容",
    inputContentPlaceholder: "输入内容；留空则处理当前整篇笔记。",
    inputContentEmptyPlaceholder: "输入或粘贴要处理的内容。",
    inputScope: "输入内容",
    addAttachment: "添加文件",
    attachments: "已添加文件",
    removeAttachment: "移除 {{name}}",
  ...
  memoList: {
    ...
    newMemo: "新建笔记",
    dropMarkdownTitle: "松开以创建笔记",
    dropMarkdownDescription: "支持单个 .md 或 .markdown 文件",
    importMarkdownFailedTitle: "无法导入 Markdown 文件",
    importMarkdownSingleFile: "请一次只拖入一个 Markdown 文件。",
    importMarkdownUnsupported: "仅支持 .md 或 .markdown 文件。",
    importMarkdownReadFailed: "文件读取或笔记创建失败，请重试。",
    importScreenshotFailedTitle: "无法将截图保存到笔记",
    importScreenshotEmpty: "截图图片为空。请重新截取；若是第一次使用，请在系统设置中允许 EdgeEver 使用屏幕录制。",
    importScreenshotFailed: "无法将截图保存为笔记。请检查网络后重试。",
    importWeChatFailedTitle: "无法保存微信聊天记录",
    importWeChatUnrecognized: "这个压缩包不是微信导出的聊天记录。",
    importWeChatFailed: "无法把聊天记录保存为笔记。请重试。",
    importWeChatInProgress: "正在导入微信聊天记录…",
    importWeChatRetryHint: "聊天记录仍保存在下载目录。请重试导入。",
    importWeChatRetry: "重试导入",
  ...
  sharing: {
    ...
    descriptionProtected: "获得链接的人需要输入密码后，才能查看这篇笔记最新保存的内容。",
    linkLabel: "公开分享链接",
    ...
    passwordSet: "已设置访问密码",
    passwordPrefix: "密码：",
    passwordRequiredTitle: "需要访问密码",
    passwordRequiredHint: "这篇分享笔记设有访问密码，请输入后查看。",
    passwordSubmit: "查看笔记",
    passwordInvalid: "密码不正确，请重试。",
    passwordRateLimited: "尝试次数过多，请稍后再试。",
    readOnly: "只读分享",
  ...
  workspaceDialogs: {
    ...
    deleteNotebookDescription: "其中的空子笔记本会一起删除。如果里面还有笔记，需要先移走或删除。删除后无法从这里恢复。",
    deleteNotebookFailedTitle: "没能删除这个笔记本",
    deleteNotebookNotEmpty: "这个笔记本或它的子笔记本里还有笔记。请先把笔记移走或删除，再删除笔记本。",
    deleteNotebookFailed: "删除没有完成，笔记本还在。请稍后重试。",
    ok: "知道了",
  ...
  pwa: {
    ...
    sidebarWindowsAvailability: "安装包未签名——Windows 或组织策略可能警告或阻止安装。请仅从官方 GitHub Release 下载。",
    sidebarLinux: "Linux",
    sidebarLinuxAvailability: "x86_64 AppImage——发行版为尽力支持。请仅从官方 GitHub Release 下载。",
