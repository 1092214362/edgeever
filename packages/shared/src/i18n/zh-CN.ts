...
export const zhCN = {
  ...
  settings: {
    ...
    pdfPreviewDefaultTitle: "默认展开 PDF 预览",
    pdfPreviewDefaultDescription: "开启后，笔记内 PDF 默认直接显示内容；关闭后默认显示紧凑卡片。偏好保存在当前浏览器中。",
    pdfPreviewDefaultAria: "笔记内 PDF 是否默认展开预览",
  ...
  pwa: {
    ...
    sidebarWindowsBadge: "即将推出",
    sidebarWindowsAvailability: "即将推出，敬请期待",
