...
export const zhCN = {
  ...
  aiAssistant: {
    title: "AI 笔记助手",
    description: "AI 输出会先作为草稿展示，只有你主动操作后才会修改笔记。",
    open: "打开 AI 写作助手",
  ...
  mcp: {
    ...
    copyExample: "复制示例",
    accessLevelTitle: "Token 访问权限",
    accessLevels: {
      full: {
        label: "完全访问",
        description: "可读取、创建和修改所有笔记、笔记本、标签及附件，并将笔记软删除至回收站。",
      },
      "read-only": {
        label: "只读访问",
        description: "可读取所有笔记、笔记本、标签及附件，但不能进行修改。",
      },
      "legacy-custom": {
        label: "旧版自定义权限",
      },
    ...
    description: "用于网页剪藏插件、MCP 服务及 AI Agent 联动，授权读取和管理你的笔记。",
    namePlaceholder: "Token 名称，例如：Chrome 剪藏插件 或 Claude Desktop",
