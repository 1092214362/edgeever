...
export const enUS = {
  ...
  plugins: {
    ...
    uninstall: "Uninstall",
    localOnly: "P0 extensions are installed on this device and run only while EdgeEver is open. Background schedules are not included yet.",
    noticeTitle: "Plugin",
    panel: "Plugin panel",
    ...
    marketplace: {
      ...
      description: "The marketplace is a verified index; plugin files remain distributed by developers through GitHub or public URLs.",
