...
export const enUS = {
  ...
  aiModel: {
    ...
    enabledHint: "Use this model for note AI actions.",
    test: "Test connection",
    testSucceeded: "The model endpoint responded successfully.",
    saved: "AI model settings saved.",
  ...
  aiAssistant: {
    ...
    description: "AI output is shown as a draft and never changes the note until you choose an action.",
    ...
    targetLanguagePlaceholder: "For example: English, Simplified Chinese, Japanese",
    generate: "Generate",
    stop: "Stop",
    result: "AI draft",
    resultPlaceholder: "The generated draft will appear here.",
    copy: "Copy draft",
    copied: "Draft copied.",
