...
export const enUS = {
  ...
  login: {
    ...
    instanceUnreachable: "EdgeEver could not reach this instance. Check the address and network, and confirm the instance is running. If it opens in a browser but still fails here, check its HTTPS certificate and CORS configuration.",
    instanceApiNotFound: "No EdgeEver API was found at this address. Enter the instance root URL, not an admin page or another subpage.",
    invalidCredentials: "The username or password is incorrect. Check both fields and try again.",
    sessionExpired: "Your previous login session is no longer valid. Enter your username and password to sign in again.",
    loginRateLimited: "There have been too many failed login attempts. Wait a moment before trying again.",
    instanceServerError: "The instance returned a server error (HTTP {{status}}). Try again later or check the instance logs.",
    requestRejected: "The instance rejected the login request (HTTP {{status}}). Verify the instance address and configuration.",
    invalidInstanceResponse: "This address did not return a valid EdgeEver response. Confirm that it points to an EdgeEver instance.",
    unexpectedError: "EdgeEver could not complete the login. Restart the desktop app and try again; if it continues, report the diagnostic code below.",
