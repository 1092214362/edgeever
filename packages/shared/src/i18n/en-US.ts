...
export const enUS = {
  companion: {
    ...
    discovery: {
      ...
      openCompanionDesc: "Review saved preferences, supporting choices and conversations.",
      ...
      loadFailed: "Discoveries are unavailable. Try reopening this panel later.",
      actionFailed: "The operation or sync did not finish. Inspect the receipt and current notes before trying again.",
      ...
      dismiss: "Skip this",
      kind: { move: "Suggestion · File notes", tag: "Suggestion · Add tags", insight: "Knowledge connection · No action needed", merge: "Suggestion · Combine ideas", append: "Suggestion · Add to an existing note" },
      ...
      transparency: {
        title: "Paw status",
        state: { disabled: "Not running", quiet: "Watching quietly", ready: "Latest check complete", running: "Checking", failed: "Check did not finish" },
        lastCheck: "Last check",
        neverChecked: "Not checked yet",
        nextCheck: "Next check",
        nextCheckEnabled: "After 3 idle minutes: note changes are checked daily; memory changes can trigger an earlier check, at most hourly",
        ...
        noDiscovery: "No discovery has been worth interrupting you for yet. Paw mode will quietly wait for new note changes.",
      },
    },
    "actions": {
      "confirm": "Confirm",
      ...
      "tools": {
        "create_memo": "Create note",
        "import_memos": "Import notes",
        "update_memo": "Update note",
        "trash_memos": "Move to trash",
        "restore_memos": "Restore notes",
        "move_memos": "Move notes",
        "add_tags_to_memos": "Add tags",
        "remove_tags_from_memos": "Remove tags",
        "rename_tag": "Rename tag",
        "delete_tag": "Delete tag",
        "merge_memos": "Merge notes",
        "restore_memo_revision": "Restore revision",
        "move_notebook": "Move notebook",
        "create_notebook": "Create notebook",
        "rename_notebook": "Rename notebook"
      },
      "fields": {
        "memoId": "Target note",
        "memoIds": "Target notes (execution order)",
        "notebookId": "Notebook",
        "parentId": "Parent notebook",
        "title": "Title",
        "contentMarkdown": "Full replacement content",
        "tags": "Tags",
        "name": "Name",
        "from": "Original tag",
        "to": "New tag",
        ...
        "expectedRevision": "Expected content revision",
        "isPinned": "Pinned",
      ...
      "effects": {
        "merge_memos": "Merging preserves bodies, attachments and tags. Sources enter trash and their public shares are revoked; restoring sources is not a complete undo.",
        "trash_memos": "These notes enter trash and their public shares are revoked. This is not permanent deletion.",
        "rename_tag": "Updates every note using this tag in the current account.",
        "delete_tag": "Removes this tag from every affected note in the current account without deleting note content.",
        "update_memo": "Listed fields replace their current values. Full content and tag lists are replacements, not additions. Review before confirming.",
        "restore_memo_revision": "Replaces the current content with the selected historical revision. Check the note and revision first."
      },
      "merge": "Suggested idea merge",
      "tag": "Suggested additional tags",
      ...
      "unsynced": "Go online, finish syncing notes and resolve sync conflicts before confirming this plan.",
      "syncFailed": "The changes were applied, but this device could not refresh. Sync manually to see the result; do not organize it again.",
      "status": { "applied": "Applied", "dismissed": "Dismissed", "unavailable": "Not ready or no longer valid. Request a fresh plan.", "uncertain": "Execution started but its result is not confirmed; some changes may have applied. Refresh and inspect your notes. This operation will not run again." }
    },
    "title": "Chat with EdgeEver",
    "navTitle": "EdgeEver",
    "primaryNavigation": "Main navigation",
    "preview": "Preview",
    "backToNotes": "Back to notes",
    "settings": "Settings",
    "emptyTitle": "From your notes to your ideas",
    "privacyTitle": "Sent content goes to your default model provider · Data and permissions",
    "unavailableHelp": "This is your dedicated chat and memory space. Personal memories are not read or saved in demo mode, without login enabled, or while signed out. Use a non-demo instance with login enabled and sign in to your personal account. Before chatting, configure the default model under AI integration in personal settings.",
    ...
    "stop": "Stop",
    "memoryHelp": "Paw distinguishes explicit preferences from inferred habits. Candidate or conflicting memories are not used. Your corrections take precedence. Up to 50 memories, 500 characters each.",
    "correct": "Correct",
    ...
    "backupHelp": "Preview data is not included in note ZIP backups or native mobile / desktop offline sync. Export memories, chats and organization records separately. Import merges memories and learning settings, not chats or organization records; imported inferences require confirmation. Exports contain plaintext; keep them safe.",
    "export": "Export memories and chats",
    "import": "Import memories",
    "clearHistory": "Clear chat history",
    "useMemory": "Use saved memories",
    "allowNotes": "Allow note tools (changes require confirmation)",
    "contextHelp": "No note tools run without permission. When enabled, AI can read notes, tags, notebooks and history. Creating, updating, merging, moving, tag management, trash and revision restoration show exact arguments for your confirmation. With memory off, this conversation can continue using prior turns that did not use memory. Models run only when you send.",
    "message": "What would you like to talk about?",
    "send": "Send",
    "clearHelp": "Permanently delete all chats, discoveries and operation records, and stop generation. Memories and discovery settings remain. Previously skipped source groups may reappear. Export a backup first if needed.",
    "forgetHelp": "Delete this memory and its learning evidence, block automatic relearning of the same rule, stop current generation and exclude old replies from future automatic context. Existing chat text, exported backups and provider-held data are not deleted; clear them separately if needed.",
    "configureModel": "Configure a default model in AI settings before chatting.",
    "credentialsRejected": "The default model credentials were rejected. Check the provider URL and API key in AI settings.",
    "providerPaymentRequired": "The model provider reported insufficient credit. Check the account balance and try again.",
    "providerRateLimited": "The model provider rate-limited this request. Wait a moment and try again.",
    "providerRequestRejected": "The default model rejected this request. Confirm it supports tool calling, or choose a different default model.",
    "conflict": "A memory was changed elsewhere or the 50-memory limit was reached. Refresh and try again.",
    "historyFull": "Chats and discoveries reached the combined 500-record limit. Export and clear history before continuing.",
  ...
  structuredTable: {
    ...
    selectOptionsHint: "Separate with commas",
    filter: "Filter",
    ...
    recordCountFiltered: "{{count}} / {{total}} records",
    listCounts: "{{records}} records · {{fields}} fields",
    newField: "Field {{index}}",
    fieldLimit: "Up to 40 fields",
    recordLimit: "Up to 2,000 records",
    unreadable: "This database could not be read",
    saveError: "Could not save the database",
    editSessionError: "Could not start a safe editing session. Try again later.",
    saving: "Saving",
    saved: "Saved",
    ...
    form: {
      ...
      enabled: "Accept responses",
      link: "Form link",
      copy: "Copy link",
      copied: "Copied",
      password: "Access password",
      passwordHint: "Turning this on generates a password. People need it to open the form.",
      ...
      full: "This form is no longer accepting responses",
      submitted: "Submitted",
      submitAnother: "Submit another",
      passwordRequired: "Enter the access password",
      unlock: "Open form",
      upload: "Upload attachment",
      uploadLimit: "Each attachment must be 20MB or smaller",
    },
    addAttachment: "Add attachment",
    openAttachment: "Open {{name}}",
    copyImage: "Copy image",
    imageCopied: "Copied. You can paste it.",
    copyImageFailed: "Couldn't copy the image",
    downloadAttachment: "Download {{name}}",
    removeAttachment: "Remove {{name}}",
    attachmentLimit: "Up to 10 attachments per cell",
    uploading: "Uploading",
    types: {
      text: "Text",
      number: "Number",
  ...
  diagram: {
    ...
    architectureShortcuts: "Drag handles to connect components; Enter edits; Cmd/Ctrl+D duplicates",
    addDecision: "Add decision",
    addTerminator: "Add start or end",
    addClient: "Add client",
    addFrontend: "Add frontend",
    addService: "Add service",
    addDatabase: "Add database",
    addStorage: "Add storage",
    addQueue: "Add queue",
    addSecurity: "Add security component",
    addExternal: "Add external system",
    ...
    componentCategoryAi: "AI & machine learning",
    componentCategoryDatabases: "Databases",
    componentCategoryStorage: "Storage & CDN",
    componentCategoryMiddleware: "Internet middleware",
    componentCategoryNetwork: "Network",
    componentCategorySecurity: "Security & boundaries",
    componentCategoryObservability: "Management & monitoring",
    componentCategoryExternal: "External services",
    noMatchingComponents: "No matching architecture components",
    architectureResources: {
      ...
      modelInference: "Model inference service",
    ...
    newBoundary: "System boundary",
    quickCreateTitle: "Choose the next node type",
    quickCreateShortcuts: "Press 1 / 2 / 3 to choose; Esc to cancel",
    nodeText: "Node text",
    nodeIcon: "Node icon",
    changeNodeIcon: "Change node icon",
    ...
    readFlowHint: "Read at 100%; scroll or drag to pan, Ctrl / ⌘ + scroll to zoom",
    fit: "Fit diagram",
    ...
    themeNaive: "Fizz",
    structure: "Shape",
    structureGroupMap: "Mind map",
    structureGroupLogic: "Logic chart",
    structureGroupBrace: "Brace map",
    structureGroupOrg: "Org chart",
    structureGroupTree: "Tree chart",
    structureGroupTimeline: "Timeline",
    structureGroupFishbone: "Fishbone",
    structureLogic: "Logic",
    structureMap: "Map",
    structureLine: "Line",
    structureCapsule: "Capsule",
    structureBox: "Box",
    structureCircle: "Circle",
    structureEllipse: "Ellipse",
    structureHexagon: "Hexagon",
    structureTree: "Tree",
    structureBrace: "Brace",
    structureOrg: "Org",
    ...
    exportError: "Could not export the diagram",
    save: "Save",
    ...
    editSessionError: "A safe editing session could not be opened. Try again shortly.",
    discardTitle: "Discard unsaved changes?",
    discardDescription: "Returning to the note list will lose the diagram changes you have not saved.",
  ...
  workspace: {
    ...
    selection: {
      ...
      exportHint: "Pack the last saved version of the selected notes into a Markdown ZIP with attachments",
      exporting: "Exporting",
      exportProgress: "Exporting {{completed}} / {{total}}",
      trashCannotExport: "Notes in trash cannot be exported",
      exportTooMany: "Export at most {{max}} notes at a time",
      exportLocalOnly: "Unsynced notes cannot be exported. Sync them first, then try again.",
      exportEmpty: "There are no notes to export",
      exportError: "Export failed. Check the network connection and try again.",
      exportCompleteWithSkipped: "Started downloading the Markdown ZIP. Skipped {{count}} unsynced notes.",
      deleting: "Deleting",
  ...
  notebookPane: {
    ...
    profile: "Profile",
    collapseSidebar: "Collapse notebook pane",
    expandSidebar: "Expand notebook pane",
    trash: "Trash",
  ...
  settings: {
    ...
    editorThemes: {
      ...
      letter: "Warm Page",
      guide: "Lesson Page",
      blueprint: "Navy Draft",
      journal: "Lead Issue",
      stance: "Clay Review",
      stub: "Amber Notes",
      brief: "Teal Aside",
      outline: "Violet Index",
      zen: "Mist Page",
      grove: "Forest Notes",
      "minimal-emerald": "Minimal Jade",
      "outline-emerald": "Lined Jade",
      "wechat-green": "WeChat Green",
      "modern-mint": "Fresh Mint",
      custom: "Custom",
    },
    customEditorTheme: {
      title: "Custom editor theme",
      description: "Adjust editor colors. This setting is saved in the current browser.",
      settingsTitle: "Custom theme",
      settingsDescription: "Switch editor themes from the toolbar. Manage browser-only custom palettes here.",
  ...
  plugins: {
    ...
    schedules: {
      legacyTitle: "Legacy manual tasks",
      legacyDescription: "These tasks were created manually in an earlier version. Configure new schedules in the relevant plugin settings; you can still disable or delete legacy tasks here.",
      toggle: "Enable or disable {{name}}",
      delete: "Delete {{name}}",
      history: "Run history",
      historyFor: "View run history for {{name}}",
  ...
  executionHistory: {
    centerTitle: "Scheduled task logs",
    centerDescription: "View status, duration, and error details for system background tasks.",
    openCenter: "Scheduled task logs",
    pluginSchedule: "Plugin {{plugin}} · {{key}}",
    pagination: "Run history pagination",
  ...
  objectStorage: {
    ...
    authenticationRequired: "Set EDGE_EVER_AUTH_PASSWORD in the deployment environment before saving third-party storage credentials. Docker stores this secret on the data volume so later upgrades do not lose it.",
  ...
  aiModel: {
    ...
    encryptionKeyMissing: "This instance cannot encrypt AI credentials. Set EDGE_EVER_AUTH_PASSWORD, or the optional EDGE_EVER_CREDENTIALS_ENCRYPTION_KEY, in the deployment environment and restart. Docker stores the secret on the data volume so later upgrades do not lose it.",
  ...
  aiAssistant: {
    ...
    actions: {
      ...
      "rewrite-proofread": "Rewrite & proofread",
      translate: "Translate",
    ...
    customInstructionSelected: "Tell AI what to do with this selection",
    customInstructionSelectedPlaceholder: "For example: Make it more conversational, keep the terms, and do not change the structure.",
    ...
    inputContentEmptyPlaceholder: "Type or paste the content to process.",
  ...
  memoList: {
    ...
    newMemo: "New note",
    dropMarkdownTitle: "Drop to create a note",
    dropMarkdownDescription: "Supports one .md or .markdown file",
    importMarkdownFailedTitle: "Could not import Markdown file",
    importMarkdownSingleFile: "Drag in one Markdown file at a time.",
    importMarkdownUnsupported: "Only .md and .markdown files are supported.",
    importMarkdownReadFailed: "The file could not be read or the note could not be created. Try again.",
    importScreenshotFailedTitle: "Could not save screenshot to note",
    importScreenshotEmpty: "The screenshot image was empty. Try capturing again, and allow Screen Recording for EdgeEver in System Settings if this is the first time.",
    importScreenshotFailed: "Couldn't save the screenshot as a note. Check the connection and try again.",
    importWeChatFailedTitle: "Could not save the WeChat chat",
    importWeChatUnrecognized: "This archive is not a WeChat chat export.",
    importWeChatFailed: "Couldn't save the chat as a note. Try again.",
    importWeChatInProgress: "Importing the WeChat chat…",
    importWeChatRetryHint: "The chat export is still in Downloads. Try importing it again.",
    importWeChatRetry: "Retry import",
  ...
  sharing: {
    ...
    descriptionProtected: "Anyone with the link must enter the password to view the latest saved version of this note.",
    ...
    passwordToggle: "Access password",
    ...
    passwordRequiredHint: "This shared note is password-protected. Enter the password to continue.",
    passwordSubmit: "View note",
  ...
  workspaceDialogs: {
    ...
    deleteNotebookDescription: "Empty child notebooks are deleted with it. Move or delete any notes inside first. It cannot be restored from here.",
    deleteNotebookFailedTitle: "Couldn't delete this notebook",
    deleteNotebookNotEmpty: "This notebook or one of its child notebooks still has notes. Move or delete those notes, then try again.",
    deleteNotebookFailed: "The notebook is still here. Please try again.",
    ok: "OK",
  ...
  pwa: {
    ...
    sidebarWindowsAvailability: "Unsigned installer — Windows or your organization may warn or block it. Download only from the official GitHub Release.",
    sidebarLinux: "Linux",
    sidebarLinuxAvailability: "x86_64 AppImage — distribution support is best-effort. Download only from the official GitHub Release.",
