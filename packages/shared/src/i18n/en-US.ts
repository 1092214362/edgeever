...
export const enUS = {
  ...
  aiPrompts: {
    ...
    restoreDefaultsConfirmDescription: "Missing starter prompts (like Summarize and Key points) will be re-added. Edited starters and prompts you created will not be changed.",
