...
export const enUS = {
  ...
  settings: {
    ...
    pdfPreviewDefaultTitle: "Expand PDF previews by default",
    pdfPreviewDefaultDescription: "Show PDF contents inline by default, or turn this off for compact cards. Saved in this browser.",
    pdfPreviewDefaultAria: "Expand note PDF previews by default",
  ...
  systemInfo: {
    ...
    releaseHighlightsLabel: "What's new:",
  ...
  pwa: {
    ...
    sidebarWindowsBadge: "Coming soon",
    sidebarWindowsAvailability: "Coming soon — stay tuned",
