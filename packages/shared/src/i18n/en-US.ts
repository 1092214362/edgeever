...
export const enUS = {
  ...
  editor: {
    ...
    tagPicker: {
      ...
      memoCount: "{{count}} notes",
      aiTitle: "AI tag suggestions",
      aiDescription: "Review suggestions before adding them to this note. Existing tags are preferred when they fit.",
      aiGenerate: "Suggest",
      aiRetry: "Suggest again",
      aiConfigure: "Configure a model in AI Integrations first.",
      aiFailed: "Could not generate tag suggestions.",
      aiEmpty: "No useful tags were found for this note.",
      aiExisting: "Existing",
      aiNew: "New",
      aiSelected: "Added",
      aiApply: "Add selected ({{count}})",
    },
