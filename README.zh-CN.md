...
- **全平台多端覆盖**：已上架 Chrome/Edge 网页裁剪插件；支持安装为 PWA 应用；原生移动端 App（iOS/Android）即将上线，Android APK 可在 Release 页面即刻下载体验；原生桌面端计划基于 Electron 开发。
